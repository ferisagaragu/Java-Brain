...
public class Panel extends JPanel{
    ...
    private boolean topShadow = true;
    private boolean bottomShadow = true;
    ...
    public Panel() {
        ...
        shadow.setLineColor(color);
        shadow.setShowLeftShadow(leftShadow);
        shadow.setShowRightShadow(rightShadow);
        shadow.setShowBottomShadow(bottomShadow);
        shadow.setShowTopShadow(topShadow);
    ...
    public void setLeftShadow(boolean leftShadow) {
    ...
    public void setRightShadow(boolean rightShadow) {
    ...
    public void setTopShadow(boolean topShadow) {
    ...
    public void setBottomShadow(boolean bottomShadow) {
    ...
    public void setShadowOpacity(float ShadowOpacity) {
        ...
        shadow.setShadowOpacity(ShadowOpacity);
    }
    ...
    public void setCornerSize(int cornerSize) {
        ...
        shadow.setCornerSize(cornerSize);
    }
